...
CREATE TABLE `conta` (
	...
	`fk_id_pessoa_pessoas` BIGINT(11) UNSIGNED NOT NULL,
	PRIMARY KEY (`id`),
	CONSTRAINT `fk_id_pessoa` FOREIGN KEY (`fk_id_pessoa_pessoas`) REFERENCES `pessoas` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
)
